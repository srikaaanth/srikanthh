...
public class Testng_Parameters1 {
  ...
  public void login_Test(String Browser, String Username,String Password,String jobtitle,String jobdecsr,String jobnote) throws Exception {
	  ...
	  if(Browser.equalsIgnoreCase("Chrome"))
		...
		Testng_Parameters1.OpenOrangeHRM();
		Testng_Parameters1.Login(Username,Password);
		Testng_Parameters1.Add_jobs(jobtitle,jobdecsr,jobnote);
		driver.quit();
       }
