...
public class TC02_Login_Static_Paarameters3 {
	...
	public void Login_Test(String Browser,String UserName,String Password,String Nationality) throws Exception
	{
	   ...
	   // TC02_Login_Static_Paarameters1.OpenChromeBrowser();
		TC02_Login_Static_Paarameters3.OpenOrangeHRM();
		TC02_Login_Static_Paarameters3.Login(UserName,Password);
		TC02_Login_Static_Paarameters3.AddNationalities(Nationality);
